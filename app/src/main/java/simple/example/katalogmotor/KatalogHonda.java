...
public class KatalogHonda extends AppCompatActivity {
    ImageButton btnScoopy, btnVario150,btnBeateSP,btnBeatstreet;
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        btnScoopy = findViewById(R.id.Scoopy);
        btnScoopy.setOnClickListener(v -> {
            Log.d("MAIN","Buka activity scoopy");
            Intent beat =new Intent (KatalogHonda.this,GaleriActivityHonda.class);
            beat.putExtra(JENIS_GALERI_KEY, "scoopy");
            startActivity(beat);
        });


        btnVario150 = findViewById(R.id.vario_150);
        ...
        btnBeateSP = findViewById(R.id.beateSP);
        btnBeateSP.setOnClickListener(v -> {
            Log.d("MAIN","Buka activity beateSP");
            Intent intent = new Intent(this, GaleriActivityHonda.class);
            intent.putExtra(JENIS_GALERI_KEY, "BeateSP");
            startActivity(intent);
        });
